...
int alternate_bit;
int esperando_resposta;
struct pkt ultimo_pacote;
...
void A_output(message)
  struct msg message;
{
  // caso A esteja aguardando uma resposta, não faz nada
  ...
  struct pkt packet;
{
  ...
  if(packet.checksum == calcule_checksum(packet)){
  	...
  	// se receber o ack igual ao alternate_bit
  ...
  struct pkt packet;
{
  ...
  if(packet.checksum == calcule_checksum(packet)){
	  ...
	  response.checksum = calcule_checksum(response);
